...
# docker run -d -p 80:80 -e SECRET_KEY_BASE=<a long random string> -e MAPBOX_TOKEN=pk.... --name forecast forecast
...
# Precompiling assets for production without requiring a real SECRET_KEY_BASE
